...
* From http://ptm.asu.edu/latest.html, 2018-09
* Modified for TU Delft EE2C11 and LTSPICE XVII by NvdM

.model nmos NMOS
* BSIM3 in ltspice = level 8, in pspice is level 7:
+Level = 8

+Lint = 3.96e-8 Tox = 4.05e-9 
...
+Prwg= 0.00                Wr= 1.0000000               U0= 3.27E-02 
